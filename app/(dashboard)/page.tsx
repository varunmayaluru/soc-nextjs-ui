...
import { ChevronRight, BookOpen, CheckSquare, Clock } from "lucide-react"

export default function Dashboard() {
  return (
    <div className="p-6">
      {/* Learning Overview Banner */}
      <div className="bg-[#1e74bb] text-white p-4 rounded-t-lg mb-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
          ...
          <div className="flex items-center justify-between">
            <p className="font-medium">
              <span className="text-[#55c3ff]">8</span> <span className="text-gray-800">Tasks</span>{" "}
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
          ...
          <div className="flex items-center justify-between">
            <p className="font-medium">
              <span className="text-[#ff9f43]">8</span> <span className="text-gray-800">Hours</span>{" "}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-medium">Hindhi</h3>
